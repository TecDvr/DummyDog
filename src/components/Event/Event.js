    ...
    render() {
        ...
        return (
            <div className="landing-container">
                <div className="title">
                  <h1>
                    <i className="fas fa-shipping-fast"></i> Send Some Events
                  </h1>
                ...
                <div className="log-selector">
                    ...
                    <Select
                        ...
                        options={[
                            ...
                            { label: "Amazon Cloudtrail", value: 'Amazon Cloudtrail' },
                ...
                <form className="api">
                    ...
                    ></input>
                    <label className="source-input-label" htmlFor="aggregation_key">
                    ...
                    ></input>
                    <label className="hostname-input-label" htmlFor="device_name">
